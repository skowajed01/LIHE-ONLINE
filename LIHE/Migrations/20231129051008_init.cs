        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    rcm = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    deptsname = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    jobtype = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    e_mail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    dept_cname = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    orign_id = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageLocation = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    webdeptname = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    visblsts = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    department_email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    rco = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    rcm = table.Column<DateTime>(type: "datetime2", nullable: true),
                    luo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    lum = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tbldeptmast", x => x.transid);
                });
